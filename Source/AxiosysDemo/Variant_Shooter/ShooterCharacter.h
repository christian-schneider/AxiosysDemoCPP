 ...
 */
UCLASS(abstract)
class AXIOSYSDEMO_API AShooterCharacter : public AAxiosysDemoCharacter, public IShooterWeaponHolder
{
	GENERATED_BODY()
...
public:
	...
	/** Constructor */
	explicit AShooterCharacter(const FObjectInitializer &ObjectInitializer);
